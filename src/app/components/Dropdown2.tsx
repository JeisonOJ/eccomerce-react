...
export default function Dropdown2() {
  return (
    <div className="flex w-1/3 gap-2">
      <Menu as="div" className="relative text-right inline-block">
        <div>
        ...
        >
          <div className="py-1">
            <MenuItem>
            <div className="flex gap-2 px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900">
              <Image
                src="https://upload.wikimedia.org/wikipedia/commons/a/a4/Flag_of_the_United_States.svg"
                alt="image"
                width={20}
